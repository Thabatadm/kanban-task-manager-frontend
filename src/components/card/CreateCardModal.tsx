...
export const CreateCardModal: React.FC<CreateCardModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
      <div className="w-full max-w-lg bg-bg-card-light dark:bg-bg-card-dark border border-border-grid-light dark:border-border-grid rounded-3xl p-6 shadow-2xl font-main relative overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        <div className="flex items-center justify-between mb-6 pb-3 border-b border-dashed border-border-grid-light dark:border-border-grid/40">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-title text-black dark:text-white uppercase tracking-tighter">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 justify-end pt-4 border-t border-dashed border-border-grid-light dark:border-border-grid/40">
            <Button
              type="button"
              variant="secondary"
              onClick={handleClose}
              className="px-4 py-2.5 text-xs font-title uppercase tracking-widest"
            >
              Abort
            </Button>
            <Button
              ...
              variant="primary"
              disabled={loading}
              className="px-5 py-2.5 text-xs font-title uppercase tracking-widest shadow-lg shadow-brand-accent/10"
            >
