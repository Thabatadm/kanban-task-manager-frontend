...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full mt-auto bg-bg-sub-dark pt-8 pb-6 border-t border-dashed border-border-grid/30 font-terminal">
      <div className="px-6 grid grid-cols-2 md:grid-cols-3 gap-y-8 gap-x-6 md:gap-x-12 md:divide-x md:divide-border-grid/30 text-[11px] text-white/70 uppercase tracking-wider text-center items-center py-2">
        ...
        <div className="md:pl-12 flex flex-col gap-3 text-center w-full">
          ...
          <div className="col-span-2 md:col-span-1 md:pl-12 flex flex-col gap-1 text-center w-full pt-6 border-t border-border-grid/10 md:pt-0 md:border-0">
          ...
          <span className="text-[10px] text-white/40 tracking-widest pt-2 w-full mt-1">
